      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          <Link
            ...
            className="group project-card grid md:grid-cols-2 gap-0 rounded-2xl border border-border bg-card/40 backdrop-blur overflow-hidden hover:bg-card/70"
          >
            {featured.cover_image_url ? (
              <div className="project-media aspect-[16/10] md:aspect-auto overflow-hidden bg-secondary">
                <img
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {rest.map((p, i) => (
              ...
              >
                <Link
                  to={`/blog/${p.slug}`}
                  className="group project-card block rounded-2xl border border-border overflow-hidden h-full bg-card/30"
                >
                  {p.cover_image_url && (
                    <div className="project-media aspect-[16/9] overflow-hidden bg-secondary">
                      <img
