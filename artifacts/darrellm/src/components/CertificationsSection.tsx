...
import { useCertifications } from "@/hooks/use-site-data";
          ...
          {certs.map((c, i) => {
            ...
            return (
              ...
              >
                <Wrapper
                  {...wrapperProps}
                  className="group project-card block h-full rounded-2xl border border-border bg-card/40 backdrop-blur p-5 hover:bg-card/70"
                >
